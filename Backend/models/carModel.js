...
const carBookingSchema = new mongoose.Schema({
    bookingId: { type: Schema.Types.ObjectId, ref: 'Booking', requried: true },
...
const carSchema = new mongoose.Schema({
    ...
    bookings: { type: [carBookingSchema], default: [] }, // show the id that has booked the car
});
...
carSchema.methods.getAvailabilitySummary = function (nowDate = new Date()) {
    ...
    // fillter for booking that should block availability
    ...
    // it will find next booking date
