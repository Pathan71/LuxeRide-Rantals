...
const VerifyPamentPage = () => {
  ...
  return (
    <div className='min-h-srceen flex items-center justify-center text-white p-4'>
      <div className='text-center max-w-lg'>
        <p className='mb-2'>{statusMsg}</p>
        <p className='text-sm opacity-70'>
          It this page shows 'session not found', try copying the 'session_id' from your url and verify it with your backend logs or support contact.
        </p>
      </div>
    </div>
  )
...
export default VerifyPamentPage
