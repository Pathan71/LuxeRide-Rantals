    ...
    return (
        <footer className='relative bg-gradient-to-b from-gray-950 to-black text-white pt-16 sm:pt-20 md:pt-24 overflow-hidden'>
            <div className='absolute top-0 left-0 w-full h-32 sm:h-40 md:h-48'>
                ...
                <div className='absolute top-12 w-full h-0.5 bg-gradient-to-r from-transparent via-orange-600 to-transparent' />
            </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12'>
                    <div className='space-y-4'>
                        ...
                        <div className='flex space-x-3 sm:space-x-4'>
                            {[FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaYoutube].map((Icon, i) => (
                                <a href="#" key={i} className='w-8 h-8 sm:w-10 sm:h-10 bg-gray-800 hover:bg-orange-400 transition-colors rounded-full flex items-center justify-center text-sm sm:text-base'>
                                    <Icon />
                                </a>
                            ))}
                        </div>
                    ...
                    <div>
                        <h3 className='text-lg font-[pacifico] sm:text-xl font-bold mb-4 relative pb-1'>
                            Quick Links
                            <span className='absolute left-0 bottom-0 block h-0.5 w-12 sm:w-16 bg-orange-400' />
                        </h3>
                    ...
                    <div>
                        ...
                        <ul className='space-y-3 text-gray-400 text-sm sm:text-base'>
                            <li className='flex items-start'>
                                <FaMapMarkedAlt className='text-orange-400 mt-1 mr-2' />
                                <span>123 Drive Avenue, Sakinaka, Mumbai 400072</span>
                            </li>

                            <li className='flex items-start'>
                                <FaPhone className='text-orange-400 mt-1 mr-2' />
                                <span>+91 8239475849</span>
                            </li>

                            <li className='flex items-start'>
                                <FaEnvelope className='text-orange-400 mt-1 mr-2' />
                    ...
                    <div>
                        ...
                        <form className='space-y-3'>
                            <input type="email" placeholder='Your Email Address'
                                className='w-full bg-gray-800 border border-gray-700 rounded-lg py-2 px-3 sm:py-3 sm:px-4 focus:outline-none focus:ring-2 focus:ring-cyan-500 text-white text-sm sm:text-base'
                            />

                            <button type='submit'
                                className='w-full flex items-center justify-center py-2 sm:py-3 bg-orange-400 hover:from-cyan-600 hover:to-blue-700 cursor-pointer text-white font-medium rounded-lg transition-transform duration-300 transform hover:-translate-y-1 text-sm sm:text-base'
                            >
