    ...
    return (
        <div className='min-h-screen flex items-center justify-center relative overflow-hidden transition-colors duration-500 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 sm:px-6 md:px-8 text-white'>
            ...
            <div className="absolute inset-0 z-0 overflow-hidden">
                <div className={`absolute top-1/4 left-1/5 rounded-full blur-3xl transition-all duration-1000 w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 bg-gradient-to-r from-purple-400/10 to-indigo-600/10 ${isActive ? 'translate-x-20 translate-y-10' : ''}`} />
                <div className={`absolute top-3/4 right-1/4 rounded-full blur-3xl transition-all duration-1000 w-40 h-40 sm:w-44 sm:h-44 md:w-48 md:h-48 bg-gradient-to-r from-purple-300/10 to-indigo-500/10 ${isActive ? '-translate-x-20 -translate-y-10' : ''}`} />
                <div className={`absolute bottom-1/3 left-2/3 rounded-full blur-3xl transition-all duration-1000 w-28 h-28 sm:w-32 sm:h-32 bg-gradient-to-r from-purple-200/10 to-indigo-400/10 ${isActive ? '-translate-x-10 translate-y-20' : ''}`} />
            </div>
            ...
            <div className={`w-full max-w-md mb-14 sm:mt-14 z-10 transform transition-all duration-500 hover:scale-[1.02] ${isActive ? 'scale-100 opactiy-100' : 'scale-90 opacity-0'}`}>
                <div className='relative overflow-hidden p-6 sm:p-8 rounded-3xl shadow-2xl transition-colors duration-500 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900'>
                    <div className='absolute -top-8 -right-8 w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-r from-purple-400/10 to-indigo-500/10 blur-2xl z-0' />
                    <div className='absolute -bottom-6 -left-6 w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-r from-purple-300/10 to-indigo-400/10 blur-2xl z-0' />
                    ...
                    <div className='relative z-10 text-center mb-6 sm:mb-8'>
                        <div className='mx-auto mb-2 w-24 h-24 sm:w-28 sm:h-28 rounded-full flex items-center justify-center'>
                            <div className='flex flex-col items-center text-xl md:text-2xl lg:text-2xl leading-none font-bold tracking-wider text-white'>
                                ...
                                />
                                <span className='font-bold tracking-wider'>LUXERIDE</span>
                            </div>
                        </div>

                        <h1 className='text-2xl sm:text-3xl font-bold tracking-tight bg-gradient-to-r from-purple-400 via-indigo-500 to-purple-600 bg-clip-text text-transparent'>
                            PremiumDrive
                        </h1>
                        <p className='mt-1 sm:mt-2 font-light tracking-wider text-xs sm:text-sm text-purple-300/60'>
                    ...
                    <form onSubmit={handleSubmit} className='space-y-4 sm:space-y-6'>
                        <div className='relative z-10'>
                            <div className='relative'>
                                ...
                                <input type="email" name='email'
                                    ...
                                    className='w-full pl-10 pr-3 py-3 sm:py-4 rounded-xl text-sm sm:text-base placeholder-opacity-70 border transition duration-300 focus:outline-none focus:ring-2 focus:border-transparent bg-white/5 backdrop-blur-sm text-white/90 placeholder-purple-200/40 border-white/10 focus:ring-purple-500/70'
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            <div className='absolute inset-0 transition-opacity duration-300 z-0 opacity-0 group-hover:opacity-100 bg-gradient-to-r from-purple-400/50 to-indigo-500/50' />
                        </button>
                    </form>
                    ...
                    <div className='mt-6 pt-6 border-t border-white/10 text-center text-xs sm:text-sm'>
                        ...
                        <a href="/signup"
                            className='inline-block mt-2 w-full cursor-pointer px-4 py-2 rounded-xl font-medium transition-transform duration-300 transform hover:-translate-y-0.5 bg-transparent border border-purple-500/50 text-purple-300/90 hover:bg-purple-500/10 hover:text-white/90'>
                            CREATE ACCOUNT
                        </a>
                    </div>
                </div>
