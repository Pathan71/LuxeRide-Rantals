        ...
        <div className='bg-gradient-to-br from-gray-900/50 to-gray-900/30 rounded-2xl border border-gray-800} hover:border-orange-500/50 transition-all'>
            ...
            <div className='p-5'>
                <div className='flex justify-between items-start mb-4'>
                    <div>
                        <h3 className='text-xl font-font text-white'>
                            {car.make} {car.model}
                        </h3>
                ...
                <div className='flex justify-between border-t border-gray-800 pt-4'>
                    ...
                    <button
                        ...
                        className='flex items-center text-red-400 hover:text-red-300 transition-color cursor-pointer'>
        ...
        <div>
            ...
            {type === "select" ? (
                <select
                    ...
                    className="bg-gray-800/50 border border-gray-700 w-full px-4 py-2.5 text-gray-200 rounded-lg"
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                        ...
                        <div className="flex justify-end space-x-4 pt-4">
                            <button
                                type="button"
                                onClick={onClose}
                                className="bg-gray-800/50 border border-gray-700 px-5 py-2.5 text-gray-300 rounded-xl cursor-pointer"
                            >
                                Cancel
                            </button>
                            <button type="submit"
...
const ManageCar = () => {
    ...
    const handleEditSubmit = async (playload) => {
        try {
            if (!editingCar._id) {
                await api.post('/api/cars', playload);
                toast.success("Car added");
            }
            else {
                await api.put(`/api/cars/${editingCar._id}`, playload);
